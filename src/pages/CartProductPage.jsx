...
function CartProductPage() {
    const coupon = useRef(); //coupon= 'green'
                ...
                <div className="w-full lg:w-[30%] border border-mainBlue overflow-hidden flex flex-col gap-3  sticky rounded-lg">
                    ...
                    <div className="px-5 flex flex-col gap-5">
                        ...
                        <div className="flex items-center justify-between my-4 border-b border-textColor">
                            ...
                            <span className="text-base">{currentCoupon === 'green' ? totalPrice / 2 : totalPrice}</span>
                        </div>
                        {/*discount*/}
                        <div className="">
                            ...
                            <div className="border border-slate-500 rounded-full flex items-center justify-center ">
                                ...
                                <button className="px-2 py-1 rounded-full text-mainBlue " onClick={() => handleCoupon()}>Apply</button>
                            </div>
                        </div>
                        {/*country*/}
